...
func TestStructInitArityError(t *testing.T) {
	...
	_, err := runFig(t, src)
	if err == nil {
		t.Fatal("expected error for wrong init arity")
	}
}
...
func TestStructNoInitArgsError(t *testing.T) {
	...
	_, err := runFig(t, src)
	if err == nil {
		t.Fatal("expected error for args without init")
	}
}
...
func TestStructThisOutsideMethod(t *testing.T) {
	...
	if err == nil {
		t.Fatal("expected error for this outside method")
	}
}
...
func TestStructPrint(t *testing.T) {
	...
	if !strings.HasPrefix(strings.TrimSpace(out), "Point{") {
		t.Errorf("expected Point{...}, got %q", out)
	}
}
...
func TestStructMethodArityError(t *testing.T) {
	...
	_, err := runFig(t, src)
	if err == nil {
		t.Fatal("expected error for wrong method arity")
	}
}
