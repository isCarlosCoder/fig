...
func TestCryptoSha1(t *testing.T) {
	...
	if out != "aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d" {
		t.Fatalf("wrong sha1, got %q", out)
	}
}
...
func TestCryptoSha256(t *testing.T) {
	...
	if out != "2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824" {
		t.Fatalf("wrong sha256, got %q", out)
	}
}
...
func TestCryptoBase64Encode(t *testing.T) {
	...
	if out != "RmlnTGFuZw==" {
		t.Fatalf("expected 'RmlnTGFuZw==', got %q", out)
	}
}
...
func TestCryptoBase64Decode(t *testing.T) {
	...
	if out != "FigLang" {
		t.Fatalf("expected 'FigLang', got %q", out)
	}
}
...
func TestCryptoBase64RoundTrip(t *testing.T) {
	...
	if out != "test123" {
		t.Fatalf("expected 'test123', got %q", out)
	}
}
...
func TestCryptoHexEncode(t *testing.T) {
	...
	if out != "466967" {
		t.Fatalf("expected '466967', got %q", out)
	}
}
